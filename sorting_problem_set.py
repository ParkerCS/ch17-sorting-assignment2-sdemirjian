...
for pos in range(1, len(sort_me2)):
    ...
    while sort_me2[scan_pos] > key_val and scan_pos >= 0:
...
print("Outer loop iterated", outer_loop, "times.")
print("Inner loop iterated", inner_loop, "times.")
...
for pos in range(1, len(sort_me3)):
    ...
    while sort_me3[scan_pos] > key_val and scan_pos >= 0:
        inner_loop += 1
